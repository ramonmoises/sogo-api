package com.sogoapi.controltask.security;
...
public class JWTAutenticarFiltro extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            UsuariosModel usuario = new ObjectMapper()
                    .readValue(request.getInputStream(), UsuariosModel.class);
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        DetalheUsuariosData usuarioData = (DetalheUsuariosData) authResult.getPrincipal();
